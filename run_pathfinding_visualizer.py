...
# Fix mouse click near right and bottom of graph
# Move draw_vis_text into draw function and inherit it's params
# Update algo after removing a node, maybe put current handling from left click in function?
